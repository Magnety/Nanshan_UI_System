...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', type=str, default='resnet50', help='U_Net/R2U_Net/AttU_Net/R2AttU_Net/Swin_Transformer/resnet50/SC_Swin_Transformer')
    parser.add_argument('--output_path', type=str, default='/home/ubuntu/liuyiyao/shanghai10yuan_project/Output')
    parser.add_argument('--name_path', type=str, default='/home/ubuntu/liuyiyao/shanghai10yuan_project/Dataset/4-5_3')
